...
func (data *StandaloneDatabase) Exec(client resp.Connection, args [][]byte) resp.Reply {
	defer func() {
		err := recover()
		if err != nil {
			logger.Error(err)
...
func (data *StandaloneDatabase) Close() {

}

func (data *StandaloneDatabase) AfterClientClose(c resp.Connection) {
